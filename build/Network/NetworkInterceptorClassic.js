...
exports.NetworkInterceptorClassic = void 0;
...
class NetworkInterceptorClassic extends AbstractInterceptor_1.NetworkInterceptorApi {
    _interceptor = null;
    ...
    async formatResponse(response) {
        ...
        try {
            ...
            (0, helperFunctions_1.codebudConsoleLog)('Response transfrom error');
        }
    ...
    constructor(callbacksTable) {
        super();
        this._interceptor = new ClientRequest_1.ClientRequestInterceptor();
...
exports.NetworkInterceptorClassic = NetworkInterceptorClassic;
;
